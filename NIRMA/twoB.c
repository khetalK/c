...
{
    int basicSalary;
    float netSalary, grossSalary, deduction, dearnessAllowance, houseRentAllowance, medical, providentFund, insurance;
    ...
    grossSalary = basicSalary + dearnessAllowance + houseRentAllowance + medical;
